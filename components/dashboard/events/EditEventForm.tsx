...
export function EditEventForm({ event, subjects }: {
    ...
    return (
        <form onSubmit={handleSubmit} className="rounded-[2rem] border border-zinc-100 bg-white p-5 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] dark:border-zinc-800 dark:bg-zinc-900 sm:p-10">
            {error && (
