            ...
            <main className={`flex-1 transition-all duration-300 ${isSidebarOpen ? 'lg:ml-72' : 'lg:ml-20'}`}>
                ...
                <div className="p-6 lg:p-10 max-w-7xl mx-auto">
                    ...
                    <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">Hola, Alumno! 👋</h1>
                            <p className="text-zinc-500 dark:text-zinc-400 mt-2 text-lg">Tienes nuevas tareas pendientes esta semana.</p>
                        </div>
