                    ...
                    <div className="md:col-span-2 relative h-96 rounded-3xl overflow-hidden group cursor-pointer shadow-sm hover:shadow-xl transition-shadow">
                        ...
                        <div className="absolute bottom-0 left-0 p-8 z-20 max-w-3xl">
                             <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-zinc-300 text-sm">{new Date(news[0].created_at).toLocaleDateString()}</span>
                             </div>
                             <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 group-hover:underline underline-offset-4 decoration-2">{news[0].title}</h2>
                             <p className="text-zinc-200 line-clamp-2 md:line-clamp-3 text-lg">{news[0].content}</p>
                        </div>
                    </div>
                )}
